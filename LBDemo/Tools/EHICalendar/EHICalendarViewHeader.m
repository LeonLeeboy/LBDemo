...
#import "EHICalendarViewHeader.h"

const CGFloat EHICalendarHeaderTextSize = 12.0f;

@interface EHICalendarViewHeader ()

@property (nonatomic, strong) UIView *separatorView;

@end

@implementation EHICalendarViewHeader
...
- (UIFont *)textFont
{
    ...
    return [UIFont systemFontOfSize:EHICalendarHeaderTextSize];
}
