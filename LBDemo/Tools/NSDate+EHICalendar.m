...
@implementation NSDate (EHICalendar)
...
- (NSDate *)getCurrentMonthFirstDate {
    ...
    NSDateComponents *comps = [currentCalendar components:NSCalendarUnitYear | NSCalendarUnitMonth fromDate:self];
    
    comps.day = 1;
    
    NSDate *firstDay = [currentCalendar dateFromComponents:comps];
